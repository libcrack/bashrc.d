...
# Android PATH (tools, platform tools and toolchain) {{{
export PATH="${ANDROID_NDK_ROOT}:${PATH}"
export PATH="${ANDROID_TOOLS}:${PATH}"
export PATH="${ANDROID_PLATFORM_TOOLS}:${PATH}"
# cd ${ANDROID_TOOLCHAIN}
# rm python python2
# mv python2.7 arm-linux-androideabi-python2.7
# ln -s arm-linux-androideabi-python2.7 arm-linux-androideabi-python
# ln -s arm-linux-androideabi-python2.7 arm-linux-androideabi-python2
export PATH="${ANDROID_TOOLCHAIN}:${PATH}"
# }}}

# Android Studio {{{
export ANDROID_STUDIO="${HOME}/AndroidStudio"
# }}}

# Android shell aliases {{{
